...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getMaleteoControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/MaleteoController.php';
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\FormularioMaleteoRepository' => ['privates', 'App\\Repository\\FormularioMaleteoRepository', 'getFormularioMaleteoRepositoryService', false],
            'App\\Repository\\OpinionesRepository' => ['privates', 'App\\Repository\\OpinionesRepository', 'getOpinionesRepositoryService', false],
        ], [
            'App\\Repository\\FormularioMaleteoRepository' => '?',
            'App\\Repository\\OpinionesRepository' => '?',
        ])));
    ...
    /**
     * Gets the private '.service_locator.s89cmuk' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_S89cmukService()
    {
        return $this->privates['.service_locator.s89cmuk'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\MaleteoController::homepage' => ['privates', '.service_locator.ipjTSUc', 'get_ServiceLocator_IpjTSUcService', false],
            'App\\Controller\\MaleteoController:homepage' => ['privates', '.service_locator.ipjTSUc', 'get_ServiceLocator_IpjTSUcService', false],
        ], [
            'App\\Controller\\MaleteoController::homepage' => '?',
            'App\\Controller\\MaleteoController:homepage' => '?',
        ]);
    }

    /**
     * Gets the private 'App\Repository\FormularioMaleteoRepository' shared autowired service.
     *
     * @return \App\Repository\FormularioMaleteoRepository
     */
    protected function getFormularioMaleteoRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/FormularioMaleteoRepository.php';

        return $this->privates['App\\Repository\\FormularioMaleteoRepository'] = new \App\Repository\FormularioMaleteoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\OpinionesRepository' shared autowired service.
     *
     * @return \App\Repository\OpinionesRepository
     */
    protected function getOpinionesRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OpinionesRepository.php';

        return $this->privates['App\\Repository\\OpinionesRepository'] = new \App\Repository\OpinionesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
